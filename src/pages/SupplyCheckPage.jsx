...
const SEED_SUPPLY_CHECK = [
  ...
  },
  {
    ...
    location: "RAIPUR",
    address: "Plot 45, Urla Industrial Area, Raipur, CG - 492003",
    plannedDate: "2026-06-18T09:15:00.000Z",
  ...
  },
  {
    ...
    location: "BILASPUR",
    address: "Sector C, Sirgitti Industrial Area, Bilaspur, CG - 495004",
    plannedDate: "2026-06-18T09:20:00.000Z",
    actualDate: "2026-06-18T09:45:00.000Z",
    status: "completed",
    delay: 0,
    updatedBy: "Admin User",
  ...
  },
  {
    ...
    location: "RAIPUR",
    address: "Plot 45, Urla Industrial Area, Raipur, CG - 492003",
    plannedDate: "2026-06-18T09:25:00.000Z",
    actualDate: "2026-06-18T09:50:00.000Z",
    status: "completed",
    delay: 0,
    updatedBy: "Admin User",
  ...
  },
  {
    ...
    location: "DURG",
    address: "Gate 2, Bhilai Steel Plant Industrial Area, Durg, CG - 491001",
    plannedDate: "2026-06-18T09:30:00.000Z",
    actualDate: "2026-06-18T09:55:00.000Z",
    status: "completed",
    delay: 0,
    updatedBy: "Admin User",
  ...
  },
  {
    ...
    location: "BILASPUR",
    address: "Sector C, Sirgitti Industrial Area, Bilaspur, CG - 495004",
    plannedDate: "2026-06-18T09:35:00.000Z",
    actualDate: "2026-06-18T10:00:00.000Z",
    status: "completed",
    delay: 0,
    updatedBy: "Admin User",
  ...
  },
  {
    ...
    location: "RAIPUR",
    address: "Plot 45, Urla Industrial Area, Raipur, CG - 492003",
    plannedDate: "2026-06-18T09:40:00.000Z",
    actualDate: "2026-06-18T10:05:00.000Z",
    status: "completed",
    delay: 0,
    updatedBy: "Admin User",
...
export function SupplyCheckPage() {
  ...
  // This stage's records (pushed from PrintInvoicePage)
  const [items, setItems] = useLocalStorage('procureflow_supply_check', SEED_SUPPLY_CHECK);
                    ...
                    <TableCell colSpan={10} className="py-16 text-center">
                      <div className="flex flex-col items-center gap-3 text-muted-foreground">
                        ...
                        <div className="space-y-1">
                          ...
                          <p className="text-xs">
                            {items.length === 0
                              ? 'Print invoices first — they will appear here automatically.'
